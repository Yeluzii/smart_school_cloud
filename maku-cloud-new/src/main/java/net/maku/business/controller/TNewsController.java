package net.maku.business.controller;
...
public class TNewsController {
    ...
    @PreAuthorize("hasAuthority('business:news:page')")
    ...
    @PreAuthorize("hasAuthority('business:news:get')")
    ...
    @PreAuthorize("hasAuthority('business:news:save')")
    ...
    @PreAuthorize("hasAuthority('business:news:update')")
    ...
    @PreAuthorize("hasAuthority('business:news:delete')")
